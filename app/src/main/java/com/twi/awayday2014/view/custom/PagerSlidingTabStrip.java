...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int dividerColor1 = 0x1A000000;
    private int dividerColor2 = 0x1A000000;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        dividerColor1 = a.getColor(R.styleable.PagerSlidingTabStrip_dividerColor1, dividerColor1);
        dividerColor2 = a.getColor(R.styleable.PagerSlidingTabStrip_dividerColor2, dividerColor2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < tabCount - 1; i++) {
            ...
            canvas.drawLine(tab.getRight() + dividerWidth/2, dividerPadding, tab.getRight() + dividerWidth/2, height - dividerPadding, dividerPaint);
        }
    }

    public void makeCurrentSelected(int currentPosition) {
        selectTextFor(currentPosition);
    }
    ...
    public void setDividerColor1(int dividerColor) {
        this.dividerColor1 = dividerColor;
        invalidate();
    }

    public void setDividerColor2(int dividerColor) {
        this.dividerColor2 = dividerColor;
        invalidate();
    }

    public void setDividerColor1Resource(int resId) {
        this.dividerColor1 = getResources().getColor(resId);
        invalidate();
    }

    public void setDividerColor2Resource(int resId) {
        this.dividerColor2 = getResources().getColor(resId);
        invalidate();
    }

    public int getDividerColor1() {
        return dividerColor1;
    }

    public int getDividerColor2() {
        return dividerColor1;
    }
