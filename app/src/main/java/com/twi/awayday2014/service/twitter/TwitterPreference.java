...
public class TwitterPreference {
    ...
    private static final String AWAY_DAY_HASH_TAG = "#awayday2014";
    private static final String THOUGHT_WORKS_HASH_TAG = "#thoughtworks";
    private static final String BANGALORE_SEARCH_TAG = "bangalore";

    private String[] HASH_TAGS = new String[] { AWAY_DAY_HASH_TAG, THOUGHT_WORKS_HASH_TAG };
    private String[] SEARCH_TAGS = new String[] { AWAY_DAY_HASH_TAG, THOUGHT_WORKS_HASH_TAG };
    ...
    public String getSearchKeyword() {
        return BANGALORE_SEARCH_TAG;
    }

    public String getHashTags() {
        return AWAY_DAY_HASH_TAG;
    }
